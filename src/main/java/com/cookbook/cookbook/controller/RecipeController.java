...
public class RecipeController {
    ...
    @PostMapping
    public ResponseEntity<Recipe> cadastrarEvento(@Valid @RequestBody Recipe recipe, UriComponentsBuilder uriComponentsBuilder) {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<Recipe> buscarEvento(@PathVariable Long id) {
        Recipe recipe = recipeService.find(id);
        return ResponseEntity.ok(recipe);
    }

    @PutMapping("/{id}")
    public ResponseEntity<Recipe> atualizarEvento(@Valid @RequestBody RecipeDTO dto, @PathVariable Long id) {
